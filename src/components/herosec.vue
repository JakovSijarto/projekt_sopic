    ...
    <div class="w-full h-[100vh] bg-black">
        ...
        <div class="absolute z-[100] absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
            <div class="w-[1340px] max-[1370px]:w-full max-[790px]:text-center">
                ...
                <p class="max-w-[645px] leading-7 text-[18px] mb-[35px] max-[1370px]:text-white max-[490px]:hidden">AP Sopic je u mogućnosti organizirati prijevoz pošiljaka svim vrstama kamiona uključujući i prijevoz specijalnih tereta, kompletnih postrojenja kao i tekućih tereta.</p>
